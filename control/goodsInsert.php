...
<form action="goodsInsert-finish.php" method="post">
<span class="yohaku">・商品名　　</span><input type="text" class="text" name="pname"><br>
<span class="yohaku">・メーカー名</span><input type="text" class="text" name="mname" ><br>
<span class="yohaku">・在庫数　　</span><input type="text" class="text" name="stock"><br>
...
<span class="yohaku">・値段　　　</span><input type="text" class="text" name="price"><br>
<span class="yohaku">・商品画像　　</span><input type="file" class="filebutton" name="image" accept="image/*"><br>
